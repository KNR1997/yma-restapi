...
class StudentService:
    ...
    async def get(self, student_id: int) -> Student | None:
        ...
        return await self.repository.get(id=student_id)
    ...
    async def create(self, student_in: StudentCreate) -> Student:
        return await self.repository.create(**student_in.model_dump())

    async def update(self, student: Student, student_in: StudentUpdate) -> Student:
        """Updates a student."""
        return await self.repository.update(student, **student_in.model_dump(exclude_unset=True))
