...
from yma.enrollment.models import Enrollment, EnrollmentCreate, EnrollmentUpdate
...
class EnrollmentService:
    ...
    async def get_by_student_and_course(self, student_id: int, course_id: int) -> Enrollment | None:
        """Gets a enrollment by id."""
        return await self.repository.get(student_id=student_id, course_id=course_id, prefetch=['course', 'student', 'student__user'])
